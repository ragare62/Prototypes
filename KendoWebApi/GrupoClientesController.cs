...
{
    /// <summary>
    /// Web API Controller for GrupoClientes entity defined in KendoModel.KendoContext data model
    /// </summary>
    public partial class GrupoClientesController : OpenAccessBaseApiController<KendoModel.GrupoCliente, KendoModel.KendoContext>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public GrupoClientesController()
        {
            this.repository = new GrupoClienteRepository();
        }
        ...
        public virtual KendoModel.GrupoCliente Get(Int32 id)
        {
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, KendoModel.GrupoCliente entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<KendoModel.GrupoCliente>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.GrupoId });
