...
{
    /// <summary>
    /// Web API Controller for Clientes entity defined in KendoModel.KendoContext data model
    /// </summary>
    public partial class ClientesController : OpenAccessBaseApiController<KendoModel.Cliente, KendoModel.KendoContext>
    {
        /// <summary>
        ...
        public ClientesController(IOpenAccessBaseRepository<KendoModel.Cliente , KendoModel.KendoContext> repository)
        {
        ...
        public virtual KendoModel.Cliente Get(Int32 id)
        {
            KendoModel.Cliente entity = repository.GetBy(k => k.Id == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, KendoModel.Cliente entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, KendoModel.Cliente entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<KendoModel.Cliente>(httpStatusCode, entityToEmbed);
