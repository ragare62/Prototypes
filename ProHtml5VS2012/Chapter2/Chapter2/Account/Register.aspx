<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Chapter2.Account.Register" %>
                    ...
                    <fieldset>
                        ...
                        <ol>
                            <li>
                                ...
                                <asp:TextBox runat="server" ID="UserName" TextMode="Email" placeholder="Use your email address" Width="200" />
