...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <header class="container metro">
            <div class="row">
                <div class="span10">
                    <img src="content/img/logo-grupo-dominguis.gif" />
                    <br />
        ...
        <div id="ContentArea" class="container metro">
            <div class="tile" style="padding:5px;" onclick="ari_openSelf('WhatDoIDoPage.html');">
                <i class="icon-image"></i>
                <h3>Dispositivo actual</h3>
                <p>El dispositivo con el que se ha conectado</p>
            </div>
            ...
            <div class="tile" style="padding:5px;" onclick="ari_openSmartphone();">
                ...
                <h3>Smartphone</h3>
                <p>Dissitivos tipo IPhone, Android...</p>
            </div>
        </div>
        <footer>
