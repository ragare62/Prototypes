...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>(C) Ariadna Software S.L. 902 888 878</title>
    </head>
    <body>
        ...
        <div class="container lead">
            ¿Quiere ser proveedor del Grupo Dominguis?
        </div>
        <div id="ContentArea" class="container metro">
            ...
            <div class="row">
                <div class="span6">
                    <div style="color:#0072BC !important;">
                        <h3>Esta es una buena zona para informar a los proveedores “novatos”</h3>
                    </div>
                    <p>Se debe pensar seriamente el contenido, con posibles enlaces a otras webs de la compañía o descarga de documentación.</p>
                </div>
            </div>
        </div>
        <footer>
