...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container lead" style="color:forestgreen;">
            <div class="icon-user lead pull-left" style="margin:5px;"></div>
        ...
        <div class="container">
            ...
            <p>Estos son los datos de su empresa que figuran en nuestros ficheros. Si alguno de ellos fueran erróneo o hubiese cambiado, escriba el dato correcto y haga clic en “Notificar cambios”.</p>
        </div>
        <div id="ContentArea" class="container metro">
            <div class="row">
                <div id="cif" class="span3" >
                    <label>CIF</label>
                    <input type="text" id="txtCIF" style="width:90%"  />
                </div>
                <div class="span3"></div>
                <div id="razon-social" class="span6">
                    <label>Razon social</label>
                    <input type="text" id="txtRazonSocial" style="width:90%" />
                </div>
            </div>
            <div class="row">
                <div class="span6">
                    <label>Dirección</label>
                    <input type="text" id="Text1" style="width:90%" />
                </div>
                <div class="span2">
                    <label>Cod.Postal</label>
                    <input type="text" id="Text2" style="width:90%" />
                </div>
                <div class="span4">
                    <label>Población</label>
                    <input type="text" id="Text3" style="width:90%" />
                </div>
            </div>
            <div class="row">
                <div>
                    <button class="btn-success pull-right">Notificar cambios</button>
                </div>
            </div>
        </div>
        <footer>
